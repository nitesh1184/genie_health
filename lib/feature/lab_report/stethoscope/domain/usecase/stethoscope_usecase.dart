...
import '../repository/stethoscope_repository.dart';

class StethoscopeUseCase extends BaseUseCase<ScreeningSuccessResponse, SaveParams> {

  final StethoscopeRepository repository;

  StethoscopeUseCase({required this.repository});
